...
describe("SiteDesigns", function () {
    ...
    if (testSettings.enableWebTests) {
        ...
        it("creates a site design", function () {
            ...
            const p = _spRest.siteDesigns.createSiteDesign({
                Title: title,
                WebTemplate: "68",
        ...
        it("deletes a site design", async function () {
            ...
            const sd = await _spRest.siteDesigns.createSiteDesign({
                Title: title,
                WebTemplate: "68",
            });

            return expect(_spRest.siteDesigns.deleteSiteDesign(sd.Id),
        ...
        it("fails to delete a site design with non-existing id", function () {
            ...
            return expect(_spRest.siteDesigns.deleteSiteDesign(null),
        ...
        it("gets the site design metadata", async function () {
            ...
            return expect(_spRest.siteDesigns.getSiteDesignMetadata(sd.Id),
        ...
        it("applies a site designs", async function () {
            ...
            return expect(_spRest.siteDesigns.applySiteDesign(sd.Id, testSettings.sp.webUrl),
        ...
        it("updates a site designs", async function () {
            ...
            return expect(_spRest.siteDesigns.updateSiteDesign({
                Id: sd.Id,
                Title: updatedTitle,
        ...
        it("gets all the site designs", async function () {
            ...
            return expect(_spRest.siteDesigns.getSiteDesigns(),
        ...
        it("gets the site designs rights", async function () {
            ...
            return expect(_spRest.siteDesigns.getSiteDesignRights(sd.Id),
        ...
        it("grants the site design rights", async function () {
            ...
            return expect(_spRest.siteDesigns.grantSiteDesignRights(
                sd.Id,
                [testuser],
        ...
        it("revokes the site design rights", async function () {
            ...
            await _spRest.siteDesigns.grantSiteDesignRights(sd.Id, [testuser]);

            return expect(_spRest.siteDesigns.revokeSiteDesignRights(sd.Id, [testuser]),
        ...
        it("gets the site design runs", async function () {
            ...
            return expect(_spRest.web.getSiteDesignRuns(),
        ...
        it("adds a site design task with absolute web url", async function () {
            ...
            createdSiteDesignIds.push(sd.Id);
            // TODO: Validate this test
            return expect(_spRest.siteDesigns.addSiteDesignTask(testSettings.sp.webUrl, sd.Id),
        ...
        it("adds a site design task", async function () {
            ...
            createdSiteDesignIds.push(sd.Id);
            const siteDesignTask = await _spRest.web.addSiteDesignTask(sd.Id);
        ...
        it("gets a site design task", async function () {
            ...
            const originalTask = await _spRest.web.addSiteDesignTask(sd.Id);

            return expect(_spRest.siteDesigns.getSiteDesignTask(originalTask.ID),
        ...
        it("gets a site design run status", async function () {
            ...
            do {
                await sleep(10000);
                task = await _spRest.siteDesigns.getSiteDesignTask(originalTask.ID);
            }
            while (task != null);

            const siteDesignRuns: ISiteDesignRun[] = await _spRest.web.getSiteDesignRuns();

            return expect(_spRest.web.getSiteDesignRunStatus(siteDesignRuns[0].ID),
                "site design task should've been created").to.eventually.be.fulfilled;
        });

        after(function () {
            return Promise.all(createdSiteDesignIds.map((sdId) => {
                return _spRest.siteDesigns.deleteSiteDesign(sdId);
            }));
        });
    }
});
