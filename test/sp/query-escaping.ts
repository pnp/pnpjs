...
describe("Query Escaping", function () {
    ...
    before(pnpTest("201839fc-f002-488e-99ba-fa2651267627", function () {
    ...
    it("single quote in path", pnpTest("5431acc8-2ab6-4aee-b19d-1afba2de162f", function () {
    ...
    it("random chars in path", pnpTest("4b37a3e0-e034-4a03-b30f-4ef4b5c2d43b", function () {
    ...
    it("aliasing", pnpTest("67f643d8-d950-4017-a78d-775c4fea1076", function () {
