...
const field = await sp.web.lists.getByTitle("My List").fields.getById("03b05ff4-d95d-45ed-841d-3855f77a2483");
...
const field = await sp.web.lists.getByTitle("My List").fields.getByTitle("Author");
...
const field = await sp.web.lists.getByTitle("My List").fields.getByInternalNameOrTitle("ModifiedBy");
...
const field = await sp.web.lists.getByTitle("My List").fields.createFieldAsXml(testFieldSchema);
...
const field = await sp.web.lists.getByTitle("My List").fields.add("My Field", "SP.FieldText", { FieldTypeKind: 3, Group: "My Group" });
...
const field = await sp.web.lists.getByTitle("My List").fields.addText("My Field", 255, { Group: "My Group" });
...
const field = await sp.web.lists.getByTitle("My List").fields.addCalculated("My Field", "=Modified+1", DateTimeFieldFormatType.DateOnly, FieldTypes.DateTime, { Group: "MyGroup" });
...
const field = await sp.web.lists.getByTitle("My List").fields.addDateTime("My Field", DateTimeFieldFormatType.DateOnly, CalendarType.Gregorian, DateTimeFieldFriendlyFormatType.Disabled, { Group: "My Group" });
...
const field = await sp.web.lists.getByTitle("My List").fields.addCurrency("My Field", 0, 100, 1033, { Group: "My Group" });
...
const field = await sp.web.lists.getByTitle("My List").fields.addMultilineText("My Field", 6, true, false, false, true, { Group: "My Group" });
...
const field = await sp.web.lists.getByTitle("My List").fields.addUrl("My Field", UrlFieldFormatType.Hyperlink, { Group: "My Group" });
...
const field = await sp.web.lists.getByTitle("My List").fields.addUser("My Field", FieldUserSelectionMode.PeopleOnly, { Group: "My Group" });
...
const field = await sp.web.fields.addLookup("My Field", list.data.Id, "Title",  { Group: "My Group" });
// create a new lookup field called 'My Field' based on an existing list 'My Lookup List' showing 'Title' field in list 'My List'
const field = await sp.web.lists.getByTitle("My List").fields.addLookup("My Field", list.data.Id, "Title",  { Group: "My Group" });
...
const field = await sp.web.lists.getByTitle("My List").fields.addChoice("My Field", choices, ChoiceFieldFormatType.Dropdown, false, { Group: "My Group" });
...
const field = await sp.web.lists.getByTitle("My List").fields.addMultiChoice("My Field", choices, false, { Group: "My Group" });
...
const field = await sp.web.lists.getByTitle("My List").fields.addBoolean("My Field", { Group: "My Group" });
...
const fieldDep = await sp.web.fields.addDependentLookupField("My Dep Field", field.data.Id, "Description");
...
const field = await sp.web.lists.getByTitle("My List").fields.getByTitle("My Field");
const fieldDep = await sp.web.lists.getByTitle("My List").fields.addDependentLookupField("My Dep Field", field.data.Id, "Description");

// we can use this 'fieldDep' variable to run more queries on the field:
const r = await fieldDep.select("Id")();
...
const field = await sp.web.lists.getByTitle("My List").fields.addLocation("My Field", { Group: "My Group" });
...
const fieldUpdate = await sp.web.lists.getByTitle("My List").fields.getByTitle("My Field").update({ Description: "My Description" });
```
