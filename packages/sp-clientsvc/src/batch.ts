...
import { CachingParserWrapper, Batch, ODataBatchRequestInfo } from "@pnp/odata";
...
export interface IObjectPathBatch extends Batch {
 ...
 */
export class ObjectPathBatch extends Batch implements IObjectPathBatch {
