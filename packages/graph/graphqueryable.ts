...
import { OLD_Queryable, invokableFactory, IInvokable, IRequestContext } from "@pnp/queryable";
 ...
 *
 */
export class _GraphQueryable<GetType = any> extends OLD_Queryable<GetType> {
