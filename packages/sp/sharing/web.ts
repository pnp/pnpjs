...
// import { _OLD_SharePointQueryableInstance } from "../sharepointqueryable.js";
...
//     const web = new _OLD_SharePointQueryableInstance(extractWebUrl(this.toUrl()), "/_api/web/url");
...
//     return OLD_spPost(Web(this, "unshareObject"), body({ url }));
// };
