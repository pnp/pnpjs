...
describe("Lists", () => {
    ...
    describe("getByTitle", () => {
        it("Should return _api/web/lists/getByTitle('Tasks')", () => {
            const list = lists.getByTitle("Tasks");
    ...
    describe("getById", () => {
        it("Should return _api/web/lists('4FC65058-FDDE-4FAD-AB21-2E881E1CF527')", () => {
            const list = lists.getById("4FC65058-FDDE-4FAD-AB21-2E881E1CF527");
    ...
    if (testSettings.enableWebTests) {
        ...
        describe("ensure", () => {
            it("Should ensure a list with the expected title", () => {
                return expect(sp.web.lists.ensure("pnp testing ensure").then(() => {
                    return sp.web.lists.getByTitle("pnp testing ensure").select("Title").get();
    ...
    if (testSettings.enableWebTests) {
        ...
        describe("contentTypes", () => {
            it("should return a list of content types on the list", () => {
                return expect(sp.web.lists.getByTitle("Documents").contentTypes.get()).to.eventually.be.fulfilled;
            });
        });

        describe("items", () => {
            it("should return items from the list", () => {
                return expect(sp.web.lists.getByTitle("Documents").items.get()).to.eventually.be.fulfilled;
            });
        });

        describe("views", () => {
            it("should return views from the list", () => {
                return expect(sp.web.lists.getByTitle("Documents").views.get()).to.eventually.be.fulfilled;
            });
        });

        describe("fields", () => {
            it("should return fields from the list", () => {
                return expect(sp.web.lists.getByTitle("Documents").fields.get()).to.eventually.be.fulfilled;
            });
        });

        describe("defaultView", () => {
            it("should return the default view from the list", () => {
                return expect(sp.web.lists.getByTitle("Documents").defaultView.get()).to.eventually.be.fulfilled;
            });
        });

        describe("userCustomActions", () => {
            it("should return the user custom actions from the list", () => {
                return expect(sp.web.lists.getByTitle("Documents").userCustomActions.get()).to.eventually.be.fulfilled;
            });
        });

        describe("effectiveBasePermissions", () => {
            it("should return the effective base permissions from the list", () => {
                return expect(sp.web.lists.getByTitle("Documents").effectiveBasePermissions.get()).to.eventually.be.fulfilled;
            });
        });

        describe("eventReceivers", () => {
            it("should return the event receivers from the list", () => {
                return expect(sp.web.lists.getByTitle("Documents").eventReceivers.get()).to.eventually.be.fulfilled;
            });
        });

        describe("relatedFields", () => {
            it("should return the related fields from the list", () => {
                return expect(sp.web.lists.getByTitle("Documents").relatedFields.get()).to.eventually.be.fulfilled;
            });
        });

        describe("informationRightsManagementSettings", () => {
            it("should return the information rights management settings from the list", () => {
                return expect(sp.web.lists.getByTitle("Documents").informationRightsManagementSettings.get())
        ...
        describe("getView", () => {
            it("should return the default view by id from the list", () => {
                return expect(sp.web.lists.getByTitle("Documents").defaultView.select("Id").get().then(v => {
                    return sp.web.lists.getByTitle("Documents").getView(v.Id).get();
                })).to.eventually.be.fulfilled;
            });
        });
        ...
        describe("update", () => {
            it("should create a new list, update the title, and then ensure it is set as expected", () => {
                const newTitle = "I have a new title";
                return expect(sp.web.lists.ensure("pnp testing list update").then(result => {
        ...
        describe("delete", () => {
            it("should create a new list, delete it, and then ensure it is gone", () => {
                return expect(sp.web.lists.ensure("pnp testing list delete").then(result => {
        ...
        describe("getChanges", () => {
            it("should get a list of changes", () => {
                return expect(sp.web.lists.getByTitle("Documents").getChanges({
                    Add: true,
                    DeleteObject: true,
                    Restore: true,
                })).to.eventually.be.fulfilled;
        ...
        describe("getItemsByCAMLQuery", () => {
            it("should get items based on the supplied CAML query", () => {
                ...
                return expect(sp.web.lists.getByTitle("Documents").getItemsByCAMLQuery(caml, "RoleAssignments")).to.eventually.be.fulfilled;
            });
        });
        /* tslint:enable */
        ...
        describe("renderListData", () => {
            it("should return a set of data which can be used to render an html view of the list", () => {
                ...
                return expect(sp.web.lists.ensure("pnp testing renderListData").then(result => {
                    return Promise.all([
                    ...
                    return l.renderListData("<View><RowLimit>5</RowLimit></View>");
        ...
        describe("renderListFormData", () => {
            it("should return a set of data which can be used to render an html view of the list", () => {
                ...
                return expect(sp.web.lists.ensure("pnp testing renderListFormData").then(result => {
        ...
        describe("reserveListItemId", () => {
            it("should return a number", () => {
                ...
                return expect(sp.web.lists.ensure("pnp testing reserveListItemId").then(result => {
