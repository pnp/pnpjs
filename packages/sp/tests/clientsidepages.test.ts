    ...
    if (testSettings.enableWebTests) {
        ...
        describe("create", () => {
            ...
            it("Should create a new page", () => {
                return expect(sp.web.addClientSidePage(`TestingAdd_${Util.getRandomString(4)}.aspx`)).to.eventually.be.fulfilled;
            });
        });
        ...
        describe("save", () => {
            ...
            it("Should update a pages content with a text control", () => {
                return sp.web.addClientSidePage(`TestingAdd_${Util.getRandomString(4)}.aspx`).then(page => {
        ...
        describe("Page comments", () => {
            ...
            before(done => {
                sp.web.addClientSidePage(`TestingAdd_${Util.getRandomString(4)}.aspx`).then(p => {
                    page = p;
                    done();
                });
            });
